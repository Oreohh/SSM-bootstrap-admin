...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <!-- /屏幕变窄出现一个下拉菜单 -->
            <a href="main" class="navbar-left">
                <img src="${pageContext.request.contextPath}/img/icon.png" width="50px">
                <a class="navbar-brand" href="main">物联网管理系统</a>
            </a>
        </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a> <span class="glyphicon glyphicon-th-list"></span>&emsp;app模拟页面</a></li>
                <li><a href="appSimulation" target="mainframe">&emsp;&emsp;app设备管理</a></li>
            </ul>
        </div>
        <!-- /左侧导航栏 -->
