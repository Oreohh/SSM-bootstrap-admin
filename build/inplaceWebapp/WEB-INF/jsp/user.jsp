    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1">查询结果</h4>
            </div>
            <div class="modal-body">
                <form id="showUserInfo">
                    ...
                    <div class="form-group">
                        <label>用户角色：</label>
                        <input type="text" id="showRoleKey" name="roleKey" class="form-control" placeholder="" readonly="readonly">
                    </div>
                </form>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addUserInfo">
                    <div class="form-group">
                        <label>用户名：(请输入6-18位字符，又英文数字下划线组成！)</label>
                    ...
                    <div class="form-group">
                        <label>用户角色：</label>
                        <input id="addRoleKey" name="roleKey" type="text" class="form-control" placeholder="">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="updateUserInfo">
                                    ...
                                    <div class="form-group">
                                        <label>用户角色：</label>
                                        <input id="editRoleKey" name="RoleKey" type="text" class="form-control" placeholder="">
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
