        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="showDevInfo">
                    ...
                    <div class="form-group">
                        <label>设备状态：(true-在线 false-离线)</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>设备类型：(1-灯   2-空调   3-窗帘   4-手机   5-电脑)</label>
                    <input id="addDevType" name="devType" type="text" class="form-control" placeholder="">
                </div>
                <div class="form-group">
                    <label>设备状态：(0-离线 1-在线)</label>
...
<div class="table-responsive">
    ...
    <tbody id="result" >
        ...
        <tr>
            ...
            <td>${devList.sDevType}</td>
            <td>${devList.devBuydate}</td>
            <td>${devList.devWarrantydate}</td>
            <td>${devList.devStatus eq true ? "在线":"离线"}</td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="updateDevInfo">
                                    ...
                                    <div class="form-group">
                                        <label>设备类型：(1-灯   2-空调   3-窗帘   4-手机   5-电脑)</label>
                                        <input type="text" id="editDevType" name="devType" class="form-control" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label>设备状态：(true-在线 false-离线)</label>
                                    ...
                                    <div class="form-group">
                                        <label>近次维修时间：</label>
                                        <input type="date" id="editDevRepairDate" name="devRepairdate" class="form-control" placeholder="">
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
